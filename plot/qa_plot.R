...
#' at https://github.com/preprocessed-connectomes-project/abide
...
qa.descs    <- list(
    anat_cnr  = "Contrast to Noise Ratio (CNR)", 
    anat_efc  = "Entropy Focus Criteria (EFC)", 
    anat_fber = "Foreground to Background Energy Ratio (FBER)", 
    anat_fwhm = "FWHM in mm", 
    anat_qi1  = "Percent of Artifact Voxels (Qi1)",
    anat_snr = "Signal to Noise Ratio (SNR)"
)
